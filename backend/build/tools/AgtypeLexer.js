...
var AgtypeLexer = exports["default"] = /*#__PURE__*/function (_antlr4$Lexer) {
  function AgtypeLexer(input) {
    var _this;
    (0, _classCallCheck2["default"])(this, AgtypeLexer);
    _this = _callSuper(this, AgtypeLexer, [input]);
    _this._interp = new _antlr["default"].atn.LexerATNSimulator(_this, atn, decisionsToDFA, new _antlr["default"].PredictionContextCache());
    return _this;
  }
  (0, _inherits2["default"])(AgtypeLexer, _antlr4$Lexer);
  return (0, _createClass2["default"])(AgtypeLexer, [{
    key: "atn",
    get: function get() {
      return atn;
    }
